      ...
      <ContextMenuTrigger>
        <div>
          <div
            ...
            className={`select-none cursor-pointer ${isSelected ? `bg-accent text-accent-foreground ${selectionStyle}` : "text-foreground hover:bg-accent/50"
              } px-1`}
              ...
              {item.children ? (
                <div className="flex items-center gap-2 flex-1 group">
                  ...
                  {selectedCount !== null && selectedCount > 0 && (
                    <Badge
                      variant="secondary"
                      className="mr-2 bg-muted text-muted-foreground hover:bg-muted"
                    >
